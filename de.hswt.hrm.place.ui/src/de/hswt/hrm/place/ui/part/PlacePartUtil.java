...
public final class PlacePartUtil {
    ...
    public static List<ColumnDescription<Place>> getColumns() {
        ...
        columns.add(getLocationColumn());
        columns.add(getAreaColumn());
        
        return columns;
    }
    
    private static ColumnDescription<Place> getPlaceColumn() {
        return new ColumnDescription<Place>(
                "Place Name",
    ...
    private static ColumnDescription<Place> getLocationColumn() {
        return new ColumnDescription<>(
                "Location",
                new ColumnLabelProvider() {
                    @Override
    ...
    private static ColumnDescription<Place> getAreaColumn() {
        return new ColumnDescription<>(
                "Area",
                new ColumnLabelProvider() {
                    @Override
