...
public class CatalogServiceTest {
	...
	private CatalogService getMockedService() {
		CatalogService service = new CatalogService(activityDao, currentDao, targetDao);
		return service;
	}
	...
	@Test
	public void testFindActivityById() throws ElementNotFoundException, DatabaseException {
		CatalogService service = getMockedService();
	...
	@Test
	public void testFindCurrentById() throws ElementNotFoundException, DatabaseException {
		CatalogService service = getMockedService();
	...
	@Test
	public void testFindTargetById() throws ElementNotFoundException, DatabaseException {
		CatalogService service = getMockedService();
	...
	public void testUpdateActivity() throws SaveException, ElementNotFoundException {
		CatalogService service = getMockedService();
		Activity activity = new Activity(5, "Some Activity", "With a little text.");
	...
	@Test
	public void testUpdateCurrent() throws SaveException, ElementNotFoundException {
		CatalogService service = getMockedService();
	...
	@Test
	public void testUpdateTarget() throws SaveException, ElementNotFoundException {
		CatalogService service = getMockedService();
	...
	@Test
	public void testRefresh() throws ElementNotFoundException, DatabaseException {
		CatalogService service = getMockedService();
