...
public class ReportGeneralComposite extends AbstractComponentRatingComposite {
	...
	public void createControls() {
		...
		generalSection = formToolkit
				.createSection(composite, Section.TITLE_BAR);
	...
	private void initializePhotoCombos() {
		if (inspection != null) {
			if (inspection.getPlantpicture().isPresent()) {
				...
				titlePhotoComboViewer.setSelection(new StructuredSelection(
						selectedPlantPhoto));

			}
			if (inspection.getFrontpicture().isPresent()) {
				selectedTitlePhoto = inspection.getFrontpicture().get();
				plantPhotoComboViewer.setSelection(new StructuredSelection(
						selectedPlantPhoto));
			}
		}
	}
	...
	private void initLayouts(Combo combo) {
		...
		try {
			...
			java.util.List<Layout> layouts = (java.util.List<Layout>) layoutService
					.findAll();
	...
	private void createPersonsComponents() {
		...
		customerClearButton.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				true, false));

		Button customerSelectionButton = formToolkit.createButton(
				personsComposite, "Select customer", SWT.PUSH);
		customerSelectionButton.setLayoutData(new GridData(SWT.RIGHT,
				SWT.CENTER, false, false));

		Label customerNameLabel = new Label(personsComposite, SWT.NONE);
		customerNameLabel
				.setLayoutData(LayoutUtil.createLeftCenteredGridData());
		formToolkit.adapt(customerNameLabel, true, true);
		customerNameLabel.setText("Name");

		customerNameText = new Text(personsComposite, SWT.READ_ONLY);
		customerNameText
				.setLayoutData(LayoutUtil.createHorzCenteredFillData(2));
		formToolkit.adapt(customerNameText, true, true);

		Label customerStreetLabel = new Label(personsComposite, SWT.NONE);
		customerStreetLabel.setLayoutData(LayoutUtil
				.createLeftCenteredGridData());
		...
		customerStreetText.setLayoutData(LayoutUtil
				.createHorzCenteredFillData(2));
		...
		Button requestorClearButton = formToolkit.createButton(
				personsComposite, "Clear requestor", SWT.PUSH);
		requestorClearButton.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				true, false));

		Button requestorSelectionButton = formToolkit.createButton(
				personsComposite, "Select requestor", SWT.PUSH);
		requestorSelectionButton.setLayoutData(new GridData(SWT.RIGHT,
				SWT.CENTER, false, false));

		Label requestorNameLabel = new Label(personsComposite, SWT.NONE);
		requestorNameLabel.setLayoutData(LayoutUtil
				.createLeftCenteredGridData());
		...
		requestorCityText.setLayoutData(LayoutUtil
				.createHorzCenteredFillData(2));
		...
		Button controllerClearButton = formToolkit.createButton(
				personsComposite, "Clear customer", SWT.PUSH);
		controllerClearButton.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				true, false));

		Button controllerSelectionButton = formToolkit.createButton(
				personsComposite, "Select customer", SWT.PUSH);
		controllerSelectionButton.setLayoutData(new GridData(SWT.RIGHT,
				SWT.CENTER, false, false));

		Label controllerNameLabel = new Label(personsComposite, SWT.NONE);
		controllerNameLabel.setLayoutData(LayoutUtil
				.createLeftCenteredGridData());
		...
		controllerCityText.setLayoutData(LayoutUtil
				.createHorzCenteredFillData(2));
		...
		customerSelectionButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				ContactSelectionDialog csd = new ContactSelectionDialog(
						shellProvider.getShell(), context);
				csd.create();
	...
	private void createVisualComponents() {
		...
		titlePhotoLabel.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				false, false, 1, 1));
		...
		titlePhotoCombo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 2, 1));
		formToolkit.paintBordersFor(titlePhotoCombo);
		titlePhotoComboViewer.setContentProvider(ArrayContentProvider
				.getInstance());
		...
		titlePhotoComboViewer
				.addSelectionChangedListener(new ISelectionChangedListener() {
					@Override
					public void selectionChanged(SelectionChangedEvent event) {
						IStructuredSelection selection = (IStructuredSelection) event
								.getSelection();
						selectedTitlePhoto = (Photo) selection
								.getFirstElement();
		...
		plantPhotoLabel.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER,
				false, false, 1, 1));
		...
		plantPhotoCombo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 2, 1));
		formToolkit.paintBordersFor(plantPhotoCombo);
		plantPhotoComboViewer.setContentProvider(ArrayContentProvider
				.getInstance());
		...
		plantPhotoComboViewer
				.addSelectionChangedListener(new ISelectionChangedListener() {
					@Override
					public void selectionChanged(SelectionChangedEvent event) {
						IStructuredSelection selection = (IStructuredSelection) event
								.getSelection();
						selectedPlantPhoto = (Photo) selection
								.getFirstElement();
	...
	private void createBiologicalComponents() {
		Composite biologicalComposite = new Composite(biologicalSection,
				SWT.NONE);
		...
		legionellaGradeCombo = new Combo(biologicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		legionellaWeightCombo = new Combo(biologicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		sumGermsGradeCombo = new Combo(biologicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		sumGermsWeightCombo = new Combo(biologicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
	...
	private void createPhysicalComponents() {
		...
		temperatureGradeCombo = new Combo(physicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		temperatureWeightCombo = new Combo(physicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		humidityGradeCombo = new Combo(physicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
		...
		humidityWeightCombo = new Combo(physicalComposite, SWT.DROP_DOWN
				| SWT.READ_ONLY);
	...
	public boolean refreshGeneralInformation() {
		...
		if (inspection == null) {
			...
			MessageDialog.openError(shellProvider.getShell(),
					"Selection error", "No inspection selected.");
			return false;
		}

		titleText.setText(inspection.getTitle());
		reportDateTime.setDay(inspection.getReportDate().get(
		...
		inspectionDateTime.setDay(inspection.getReportDate().get(
				Calendar.DAY_OF_MONTH));
		inspectionDateTime.setMonth(inspection.getReportDate().get(
				Calendar.MONTH));
		inspectionDateTime.setYear(inspection.getReportDate()
				.get(Calendar.YEAR));

		nextInspectionDateTime.setDay(inspection.getNextInspectionDate().get(
				Calendar.DAY_OF_MONTH));
		nextInspectionDateTime.setMonth(inspection.getNextInspectionDate().get(
				Calendar.MONTH));
		nextInspectionDateTime.setYear(inspection.getNextInspectionDate().get(
				Calendar.YEAR));
	...
	private void fillLegionella() {
		...
		if (inspection.getLegionellaQuantifier().isPresent()) {
			legionellaGradeCombo.select(inspection.getLegionellaQuantifier()
					.get());
		}
