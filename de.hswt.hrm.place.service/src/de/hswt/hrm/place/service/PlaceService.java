...
public class PlaceService {
     ...
     * 
     * @param place
     *            Place that should be stored.
     * @return The created place.
     * @throws SaveException
     *             If the place could not be inserted.
     */
     ...
     * 
     * @param place
     *            Place that should be updated.
     * @throws ElementNotFoundException
     *             If the given place is not present in the database.
     * @throws SaveException
     *             If the place could not be updated.
     */
