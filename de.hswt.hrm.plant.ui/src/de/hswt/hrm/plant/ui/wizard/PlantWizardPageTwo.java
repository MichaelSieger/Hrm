...
public class PlantWizardPageTwo extends WizardPage{
    ...
    public PlantWizardPageTwo(String title, Optional<Plant> plant) {
        super(title);
        this.plant = plant;
        setDescription("Zugeh�rigen Standort ausw�hlen");
    }
	@Override
	public void createControl(Composite parent) {
        
		PlaceEventHandlerForPlant eventHandler = ContextInjectionFactory.make(PlaceEventHandlerForPlant.class,context);
