...
public class CatalogAssignmentComposite extends Composite {
    ...
    private ISelectionChangedListener selectionChangedListener = new ISelectionChangedListener() {
		...
		public void selectionChanged(SelectionChangedEvent event) {
			ICatalogItem item = (ICatalogItem)((IStructuredSelection)event.getSelectionProvider().getSelection()).getFirstElement();
    ...
    public void createControls() {
        ...
        assignedTargetSearch = new Text(assignedTargetComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
        assignedTargetSearch.setLayoutData(LayoutUtil.createHorzFillData());
        formToolkit.adapt(assignedTargetSearch, true, true);

        assignedTarget = new ListViewer(assignedTargetComposite, SWT.BORDER | SWT.V_SCROLL);
        ...
        Section assignedCurrentSection = formToolkit.createSection(this, Section.TITLE_BAR);
        ...
        assignedCurrentSearch = new Text(assignedCurrentComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
        assignedCurrentSearch.setLayoutData(LayoutUtil.createHorzFillData());
        formToolkit.adapt(assignedCurrentSearch, true, true);

        assignedCurrent = new ListViewer(assignedCurrentComposite, SWT.BORDER | SWT.V_SCROLL);
        ...
        assignedActivitySearch = new Text(matchedActivityComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
        assignedActivitySearch.setLayoutData(LayoutUtil.createHorzFillData());
        formToolkit.adapt(assignedActivitySearch, true, true);

        assignedActivity = new ListViewer(matchedActivityComposite, SWT.BORDER | SWT.V_SCROLL);
        ...
        targetRemove = formToolkit.createButton(targetBtnComposite, "", SWT.DOWN
        ...
        Composite currentBtnComposite = formToolkit.createComposite(this, SWT.NONE);
        ...
        currentAdd = formToolkit.createButton(currentBtnComposite, "", SWT.ARROW
                | SWT.CENTER);
        ...
        currentRemove = formToolkit.createButton(currentBtnComposite, "", SWT.DOWN
                | SWT.ARROW | SWT.CENTER);
        ...
        activityAdd = formToolkit.createButton(activityBtnComposite, "", SWT.ARROW
                | SWT.CENTER);
        ...
        activityRemove = formToolkit.createButton(activityBtnComposite, "", SWT.DOWN
                | SWT.ARROW | SWT.CENTER);
        ...
        availableTargetSearch = new Text(targetComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
        ...
        availableCurrentSearch = new Text(currentComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
        ...
        availableActivitySearch = new Text(activityComposite, SWT.H_SCROLL | SWT.SEARCH | SWT.ICON_SEARCH | SWT.CANCEL);
    ...
    private ICatalogItem getSelectedListItem(ListViewer viewer) {
		...
		return (ICatalogItem)((IStructuredSelection)viewer.getSelection()).getFirstElement();
    }
    
    protected void handleDoubleClickEvent(Viewer viewer) {
		ICatalogItem item = (ICatalogItem)((IStructuredSelection)viewer.getSelection()).getFirstElement();
