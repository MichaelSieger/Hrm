...
public class ReportPreferencesComposite___OLD extends Composite {
	 ...
	 * @param style
	 */
	private ReportPreferencesComposite___OLD(Composite parent, int style) {
		super(parent, style);
		createControls();
	}
	 ...
	 * @param parent
	 */
	public ReportPreferencesComposite___OLD(Composite parent) {
